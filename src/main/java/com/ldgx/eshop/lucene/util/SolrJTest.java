	...
	//指定solr服务器的地址 
	   ...
	   */
	   public void addDoc() throws SolrServerException, IOException{
	    ...
	    HttpSolrClient solr = new HttpSolrClient(SOLR_URL + "solr_core");
	    solr.add(document);
	    solr.commit();
	    solr.close();
	   }
	   ...
	   */
	   public void deleteDocumentById() throws Exception { 
	     //选择具体的某一个solr core
	     HttpSolrClient server = new HttpSolrClient(SOLR_URL+"solr_core"); 
	     //删除文档 
	     server.deleteById("8"); 
	     //删除所有的索引
	     //solr.deleteByQuery("*:*");
	   ...
	   */
	   public void querySolr() throws Exception{
	     HttpSolrClient solrServer = new HttpSolrClient(SOLR_URL+"solr_core/"); 
